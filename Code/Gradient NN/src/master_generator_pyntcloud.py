...
import Datagenerator_pyntcloud as Generator
...
def run_batch(neighborhood_size=20):
    ...
    header = ["edge_mean", "plane_mean", "curvature", "linearity", "planarity", "omnivaraiance", "eigentropy", "eigensum", "grad_dist", "radius"]
    BASE_DIR = os.path.dirname(os.path.abspath(__file__))
    feature_PATH = os.path.abspath(os.path.join(BASE_DIR, f"../Data/Training_data/big_test_features_pynt_{neighborhood_size}.txt"))
    label_PATH = os.path.abspath(os.path.join(BASE_DIR, f"../Data/Training_data/big_test_labels_pynt_{neighborhood_size}.txt"))
